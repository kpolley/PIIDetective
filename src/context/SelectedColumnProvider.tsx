...
const SelectedColumnContext = createContext<
  SelectedColumnContextType | undefined
>(undefined);
...
export const SelectedColumnProvider = ({
  ...
  const [selectedColumn, setSelectedColumn] =
    useState<ColumnClassificationIncludeColumn | null>(null);
  ...
  function selectColumn(columnID: number | null) {
    ...
    const selectedColumn = columnQuery.data?.find(
...
export const useSelectedColumn = () => {
  ...
  if (context === undefined) {
    throw new Error(
      "useSelectedColumn must be used within an SelectedColumnProvider",
    );
  }
  return context;
};
