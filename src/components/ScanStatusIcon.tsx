...
export default function ScanStatusIcon({ scanStatus, setScanStatus }: ScanStatusIconProps){
    ...
    return(
        <div className="flex items-center gap-2 rounded-md bg-gray-200 px-3 py-2 text-sm font-medium dark:bg-gray-700 dark:text-white">
            ...
            <span className="ml-2 text-gray-500 dark:text-gray-400">
                {formatDistance(new Date(scanStatus.scanStart), new Date(), { addSuffix: true })}
            </span>
        </div>      
    )
}